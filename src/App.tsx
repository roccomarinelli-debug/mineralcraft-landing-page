...
const App: React.FC = () => {
  ...
  // Fixed Alpine Heritage theme - no theme switching in production
  const currentTheme = 8; // Alpine Heritage theme index
  ...
  return (
    <div className="app">
      {/* Alpine Heritage Theme - Fixed Production Version */}
